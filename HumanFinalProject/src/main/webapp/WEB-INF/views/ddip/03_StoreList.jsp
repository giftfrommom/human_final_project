...
<html lang="en">
  ...
  <symbol id="grid" viewBox="0 0 16 16">
	...
	<header class="p-3 text-bg-dark">
		...
		<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between">
			<a href="/"
				...
				<svg class="bi me-2" width="60" height="32" role="img"
					aria-label="Bootstrap">
					<use xlink:href="#bootstrap" /></svg>
			</a>

			<ul class="nav col-md-auto mb-2 justify-content-center mb-md-0">
				<li style="margin-left: 100px;"><a href="#"
					class="nav-link px-2 text-white">가게리스트</a></li>
				<li style="margin-left: 100px"><a href="#"
					class="nav-link px-2 text-white">공구페이지</a></li>
				<li style="margin-left: 100px"><a href="#"
					class="nav-link px-2 text-white">커뮤니티</a></li>
				<li style="margin-left: 100px"><a href="#"
					class="nav-link px-2 text-white">고객센터</a></li>
			</ul>

			<!-- <div class="text-end" style="margin-left: 10px;"> -->
			<button type="button" class="btn btn-outline-light me-2"
				style="margin-left: 170px;">Login</button>
			...
			<nav class="navbar navbar-dark bg-dark" style="float: right;">
				<div class="container">
					...
					<button class="navbar-toggler" type="button"
						data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbarDark"
					...
					<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1"
						...
						<div class="offcanvas-header">
							<h5 class="offcanvas-title" id="offcanvasNavbarDarkLabel">띱</h5>
						...
						<div class="offcanvas-body">
							<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
								<li class="nav-item"><a class="nav-link active"
									aria-current="page" href="#">회원정보</a></li>
								<li class="nav-item"><a class="nav-link" href="#">주문내역</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="#">쿠폰함</a></li>
								<li class="nav-item"><a class="nav-link" href="#">띱머니충전</a>
								</li>
	...
	<section class="py-5">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							 ...
							 <div class="progress position-absolute" style="bottom: -1.5rem; left: 0.3rem">
								<div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">1/4</div>
							</div>
                        </div>                   
                    </div>
                   <div class="col mb-5">
        ...
        <script>
      // 마감시간 설정
      const deadline = new Date("2023-04-17T20:00:00Z");
